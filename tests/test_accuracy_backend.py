...
from accuracy.processor import (
...
class TestCompareAndCorrect:
    ...
    def test_simple_comparison(self):
        ...
        assert corrected_df[corrected_df["produto"] == "B"]["preco_unitario"].values[0] == 20.0
    ...
    def test_missing_keys(self):
        ...
        target_df = pd.DataFrame({
            "produto": ["A", "C"],  # B is missing
            "preco_unitario": [10.0, 30.0]
        })
    ...
    def test_tolerance(self):
        ...
        target_df = pd.DataFrame({
            "produto": ["A"],
            "preco_unitario": [10.05]  # Within tolerance
        })
