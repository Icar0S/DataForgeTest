...
from .validators import validate_schema, validate_generate_request, validate_preview_request
    ...
    try:
        ...
        if llm_mode == "full" and num_rows <= 5000:
            ...
            for batch_num in range(batches):
                ...
                all_records.extend(records)
                all_logs.extend(logs)
                all_logs.append(f"Batch {batch_num + 1} complete: {len(all_records)}/{num_rows} total rows")
