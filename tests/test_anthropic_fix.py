    ...
    for attempt in range(1, max_attempts + 1):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                synth_response = requests.get('http://localhost:5000/api/synth/health', timeout=2)
...
def test_mock_data_generation():
    ...
    try:
        ...
        assert any('mock data' in log.lower() for log in logs), "Should log mock data usage"
