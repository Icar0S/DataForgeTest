...
class TestCSVEncodingIntegration(unittest.TestCase):
    ...
    def test_latin1_encoding_with_special_chars(self):
        ...
        try:
            ...
            self.assertEqual(result['detected_options']['encoding'], 'ISO-8859-1')
    ...
    def test_many_columns_csv(self):
        ...
        try:
            ...
            self.assertEqual(result['columns'][-1]['name'], 'RECEITA PREVIDENCIÁRIA - DEMAIS')
    ...
    def test_end_to_end_code_generation(self):
        ...
        try:
            ...
            self.assertEqual(dsl['dataset']['detected_options']['encoding'], 'ISO-8859-1')
    ...
    def test_utf8_csv_still_works(self):
        ...
        try:
            ...
            self.assertIn(result['detected_options']['encoding'].lower(), ['utf-8', 'ascii'])
            self.assertEqual(result['detected_options']['delimiter'], ',')
