...
class RAGDiagnostics:
    ...
    def check_environment(self):
        ...
        if env_file.exists():
            ...
            try:
                ...
                for var in required_vars:
                    if var in content:
                        ...
                        if f"{var}=" in content and f"{var}=\n" not in content and f"{var}= " not in content:
            ...
            print("  Note: Simple RAG system works without LLM API, but won't use Claude")
    ...
    def generate_report(self):
        ...
        if has_llm_warning:
            ...
            print("    2. Install: pip install llama-index-llms-anthropic llama-index-embeddings-openai")
